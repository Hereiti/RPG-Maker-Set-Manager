...
class RedSlider(QSlider):
    ...
    def __init__(self, parent):
        ...
        self.valueChanged.connect(
            lambda value: self.change_rgb(parent.parent(), value, "red"))
    ...
    def change_rgb(self, app, value, color):
        ...
        app.values["Red"].setText(str(self.value()))
    ...
    def on_image_processed(self, app, value, color, modified_image):
        ...
        app.modified_images.append(updated_pixmap)
...
class GreenSlider(QSlider):
    ...
    def __init__(self, parent):
        ...
        self.valueChanged.connect(
            lambda value: self.change_rgb(parent.parent(), value, "green"))
        self.sliderReleased.connect(
            lambda: self.on_slider_end(parent.parent()))
    ...
    def change_rgb(self, app, value, color):
        ...
        app.values["Green"].setText(str(self.value()))
...
class BlueSlider(QSlider):
    ...
    def __init__(self, parent):
        ...
        self.valueChanged.connect(
            lambda value: self.change_rgb(parent.parent(), value, "blue"))
        self.sliderReleased.connect(
            lambda: self.on_slider_end(parent.parent()))
    ...
    def change_rgb(self, app, value, color):
        ...
        app.values["Blue"].setText(str(self.value()))
