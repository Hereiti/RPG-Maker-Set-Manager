...
class HueSlider(QSlider):
    def __init__(self, parent):
        ...
        self.valueChanged.connect(
            lambda value: self.change_hsv(parent, value, "hue"))
...
class SaturationSlider(QSlider):
    def __init__(self, parent):
        ...
        self.valueChanged.connect(
            lambda value: self.change_hsv(parent, value, "saturation"))
        self.sliderReleased.connect(lambda: self.on_slider_end(parent))
...
class ValueSlider(QSlider):
    def __init__(self, parent):
        ...
        self.valueChanged.connect(
            lambda value: self.change_hsv(parent, value, "value"))
        self.sliderReleased.connect(lambda: self.on_slider_end(parent))
