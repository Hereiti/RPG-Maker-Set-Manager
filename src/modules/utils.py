...
def contributors():
    show_popup(
        """
        <h2>Special Thanks for the following person who helped with this project.</h2>
        <br>- Holder (<a href="https://holder-anibat.itch.io">itch.io</a>)
        """, "INFO", ["OK"], "Contributors")


def supporters():
    show_popup("""
        <h2>Special Thanks for the following person who showed their support.</h2>
