...
def click_cell(event, app):
    ...
    if app.animation[1]:
        ...
        image_manipulation.play_animation(app)
...
def highlight_index(app, cell_index):
    """
    ...
    if app.main_view.highlight_selected[0] is None:
        app.main_view.highlight_selected = [
            Highlight("red", app.cell_size[0], app.cell_size[1]),
            cell_index
        ]
    ...
    app.main_view.highlight_selected[0].reset_timer()
    app.main_view.highlight_selected[0].setPos(*maths.cell_origin(cell_index))
...
def get_layer_1(app, index):
    ...
    Args:
        ...
        - index: The index of the cell to retrieve the image from.
    """
    if index in app.layer_1:
        # Return the QGraphicsPixmapItem at the specified index
        return app.layer_1[index]
